...
public class UsersSearch extends TransactGlobalPage {

    public UsersSearch(WebDriver driver) {
        super(driver);
        PageFactory.initElements(driver, this);
    }

    //Role Dropdown for SEC-Users
    ...
    @FindBy(how = How.XPATH, using = "//select[@id='searchStatus']")
